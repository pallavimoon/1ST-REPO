...
public class DeletAccount {
  ...
  public void deletCustomerTab() {
	  WebElement deletAccountTab = driver.findElement(By.xpath("//a[text()='Delete Account']"));
		Assert.assertTrue(deletAccountTab.isEnabled());
		System.out.println("deletCustomerTab is enabled");
		deletAccountTab.click();
  }
  @Test(priority=2)
  public void accountToBeDeletedTab() {
	  ...
	  AccountNo.sendKeys("123abc");
		...
		AccountNo.clear();
		AccountNo.sendKeys("113470");
  }
  @Test(priority=3)
  public void submitbutton() throws InterruptedException {
	 	 driver.findElement(By.xpath("//input[@name='AccSubmit']")).click();
	 	Alert alert = driver.switchTo().alert();
		String expMsg1 = "Do you really want to delete this Account?";
		String actMsg1 = alert.getText();
		Assert.assertEquals(actMsg1, expMsg1);
		System.out.println("user is getting a alert message:Do you really want to delete this Account?");
		alert.accept();
	 	  Thread.sleep(2000);
	 	  File file1 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
	 		try {
	 			FileUtils.copyFile(file1, new File("F:\\ECLIPSE WORKSPACE\\guru99\\screenshot\\DeletAccount.png"));
	 		} catch (IOException e) {
	 			e.printStackTrace();
	 		}
}
